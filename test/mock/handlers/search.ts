...
import type {
  SearchUsersResponse,
  SearchLiveMoviesResponse,
} from "../../../src/api/search";

const exampleSearchUsersResponse = {
  users: [
    {
      id: "182224938",
...
const exampleSearchLiveMoviesResponse = {
  movies: [
    {
      movie: {
        id: "189037369",
        ...
        hls_url:
          "https://twitcasting.tv/twitcasting_jp/metastream.m3u8/?video=1",
      },
      broadcaster: {
        id: "182224938",
        screen_id: "twitcasting_jp",
    ...
    },
    {
      movie: {
        ...
        total_view_count: 71,
        hls_url:
          "https://twitcasting.tv/twitcasting_pr/metastream.m3u8/?video=1",
      },
      broadcaster: {
        id: "2880417757",
        screen_id: "twitcasting_pr",
...
export const searchHandlers = [
  http.get<never, never, SearchUsersResponse>("*/search/users", () => {
    return HttpResponse.json(exampleSearchUsersResponse);
  }),

  http.get<never, never, SearchLiveMoviesResponse>("*/search/lives", () => {
    return HttpResponse.json(exampleSearchLiveMoviesResponse);
  }),
];
